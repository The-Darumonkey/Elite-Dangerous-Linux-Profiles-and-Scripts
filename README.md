...
### Profile details
1. `Elite-SpacePilot` is a profile for the (ancient but awesome!) 3DConnexion SpacePilot Pro. It maps 5 of the axes on the 6-axis puck to gamepad analogue axes, and the buttons to keystrokes. 
